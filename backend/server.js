...
const port = process.env.SERVER_PORT || 3000;  //sets port from .env file or defaults to 3000 if not specified  
...
// express-cors middleware handles OPTIONS preflight requests automatically
